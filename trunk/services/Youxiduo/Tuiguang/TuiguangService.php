...
class TuiguangService extends BaseService{
    ...
    const API_URL_CONF="app.duoyou_count_tg_url";
    const V4_API_URL_CONF="app.duoyou_count_tg_url";
...
//        print_r($res);
    ...
    {
       $res = Utility::loadByHttp(Config::get(self::V4_API_URL_CONF).self::$arr[$method][0],$data,self::$arr[$method][1]);
...
//        print_r($res);
    ...
    public static function Excute3($data=array(),$method="",$isList=true)
    {
        ...
        $res = Utility::loadByHttp(Config::get(self::CHAN_API_URL_CONF).self::$arr[$method][0],$data,self::$arr[$method][1]);
