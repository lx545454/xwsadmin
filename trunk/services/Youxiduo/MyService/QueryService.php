...
class QueryService extends Model
{
    ...
    public static function getListByApi($inputinfo)
    {
        ...
        return DB::select('SELECT id,adv_logo,attribute,name,adv_name,adv_img,adv_content,adv_href_type,game_id,urlId,urlAddress,startTime,endTime,sort FROM '.self::$databas_table.$where,$sqlWhereValue['1']);
