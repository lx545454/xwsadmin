...
{	
    const duoyou_platform = 'duoyou.duoyou_platform';
	...
	public function getAdd()
	{
		...
		$data['platform'] = Config::get(self::duoyou_platform);
	...
	{
		$input = Input::only('group_id','group_name','group_desc','platform','plat_name');
