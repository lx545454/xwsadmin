...
function setAdv_href_type(Value){
    if(Value == '外部url' ||  Value == '内部safari'){
        ...
        return true;
    }else if(Value == '活动列表' || Value == '礼包列表' || Value =='游币商城列表' || Value =='钻石商城列表' || Value =='任务列表' || Value =='大转盘' || Value =='天天彩' || Value =='新手任务列表'){
...
function set_adv_type(adv_type){
    if(adv_type == 2){
        ...
        if(Value == 'Safari浏览器' ||  Value == '内置浏览器' || Value == '活动列表' || Value == '礼包列表' || Value =='游币商城列表' || Value =='钻石商城列表' || Value =='任务列表' || Value =='大转盘' || Value =='天天彩' || Value =='新手任务列表'){
